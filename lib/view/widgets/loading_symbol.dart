...
class LoadingSymbol extends StatefulWidget {
  const LoadingSymbol({super.key});

  @override
  State<LoadingSymbol> createState() => _LoadingSymbolState();
}

class _LoadingSymbolState extends State<LoadingSymbol> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          const Text(
            "Your Information Registering on Database",
